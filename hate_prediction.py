...
from sklearn.feature_extraction.text import (
    TfidfVectorizer,
)  # initialises an array of frequencies of words.
...
def preprocess(tweet):
    ...
    tweets = tweet_lower.str.replace(giant_url_regex, "", regex=True)
...
vectorizer = TfidfVectorizer(
    max_df=0.8, min_df=6, max_features=3000, stop_words=stopwords, ngram_range=(1, 1)
)
...
clf_stack = StackingClassifier(
    classifiers=[model_rf, model_xgb, model_nb],
